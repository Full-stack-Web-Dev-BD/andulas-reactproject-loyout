...
const Sidebar = (props: ISidebar) => {
  const { collapsed, isDisableNavigate, pathname } = props;
  ...
  return (
    <Layout.Sider
      ...
      collapsible
      collapsed={collapsed}
      className="mt-16 bg-white font-fontFamily font-semibold uppercase not-italic tracking-[0.02em] overflow-y-auto min-h-[calc(100vh-64px)] fixed left-0 top-0 bottom-0 overflow-x-hidden z-10 layout-sidebar sm:hidden isHide"
    >
      <Menu
