...
import { DATE_FORMAT_TWO, IFieldListForm, IOptionItem, ISessionDetail, ROUTES } from 'constants/index';
import moment from 'moment';
import { useCallback, useEffect, useState } from 'react';
import { useMutation, useQuery } from 'react-query';
import { useNavigate, useParams } from 'react-router-dom';
import { ISessionInfo, SESSION_DEFAULT } from '..';
...
const CommunityLibraryOverview = () => {
  ...
  return (
    ...
    <Layout className="bg-transparent flex flex-col gap-y-6">
      ...
      >
        ...
        <Breadcrumb.Item
          onClick={() => {
            history(ROUTES.community_library + `/topic/${topicId}/module/${moduleId}/session`);
          }}
          className="opacity-50 cursor-pointer"
        >
        ...
        <Form className="flex flex-wrap gap-x-6" layout="vertical" form={form}>
          ...
          <Form.Item className="w-full">
            <div className="flex gap-3 justify-end">
              ...
              <ButtonCustom color="orange" onClick={() => setIsModalDuplicateSession(true)}>Duplicate</ButtonCustom>
            </div>
          </Form.Item>
        </Form>
      </Content>
      <h4 className="mt-6 font-semibold text-[28px] font-fontFamily custom-font-header">Used in Course</h4>
...
export default CommunityLibraryOverview;
