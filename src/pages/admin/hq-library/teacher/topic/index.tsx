...
import { searchModules } from 'api/hq_library';
  ...
  return (
    <Layout className="bg-transparent flex flex-col gap-y-6">
      ...
      <FilterCard
        ...
        pathSearchDetail={`${ROUTES.hq_library}/topic`}
      ...
      <CardResult
        onRedirect={(id) => {
          history(`${ROUTES.hq_library}/topic/${id}/module/teacher`);
        }}
...
export default HQLibraryTopicTeacher;
