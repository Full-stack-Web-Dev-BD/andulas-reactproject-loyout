  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: string, record: ISessionInfo) => {
        return (
          <div>
            <CustomTooltip title={moduleName}>
              <div className="custom-text-ellipsis">{moduleName}</div>
            </CustomTooltip>
          </div>
        );
      },
    ...
    <>
      <Layout className="bg-transparent flex flex-col gap-y-6">
        ...
        <FilterCard
          ...
          pathSearchDetail={`${ROUTES.hq_library}/topic/${topicId}/module/${moduleId}/session`}
