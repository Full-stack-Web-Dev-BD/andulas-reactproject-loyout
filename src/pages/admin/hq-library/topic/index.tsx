import { Form, Layout, notification, TablePaginationConfig, Row, Col } from 'antd';
  ...
  return (
    <Layout className="bg-transparent flex flex-col gap-y-6">
      ...
      <FilterCard
        ...
        pathSearchDetail={ROUTES.hq_library_topic}
      ...
      <CardResult
        onRedirect={(id) => {
          history(`${ROUTES.hq_library_topic}/${id}/module`);
        }}
