import { Breadcrumb, Form, Layout, notification, TablePaginationConfig, Row, Col } from 'antd';
...
const HQLibraryModule = () => {
  ...
  const [filters, setFilters] = useState<Record<string, any>>({ topicType: TopicType.HQ_LIBRARY });
  ...
  return (
    <Layout className="bg-transparent flex flex-col gap-y-6">
      ...
      <FilterCard
        ...
        pathEndPointSearchDetail="/session"
      />
...
export default HQLibraryModule;
