...
const OverviewSessionContentManagement = () => {
 ...
 const handleDuplicateUnits = (newSessionId: number) => {
  ...
  const onClickReview = () => {
    history(`${ROUTES.content_management}/session/${sessionId}/content-creation`);
  }
        ...
        <Form className="flex flex-wrap gap-x-6" layout="vertical" form={form}>
          ...
          <Form.Item className="w-full">
            <div className="flex gap-3 justify-end">
              <ButtonCustom color="outline" onClick={onClickReview}>Review</ButtonCustom>
              <ButtonCustom
                color="orange"
                onClick={() => {
...
export default OverviewSessionContentManagement;
