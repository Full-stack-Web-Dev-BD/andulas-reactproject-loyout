...
const CreateUnitWithAudio = (props: IProps) => {
  const {
    sessionData,
    selectedUnit,
    handleAddOrEditUnit,
  ...
  const { mutate: mutateGetFileUrl } = useMutation('getFileUrl', getFileUrlNotExpire, {
    onSuccess: ({ data }: { data: { fileUrl: string } }) => {
      ...
      setUrlContent(
        `<audio style='width: 100%' controls src='${data?.fileUrl || ''
    ...
    <div className="">
              ...
              {uploadedFileUrl && uploadedFileUrl !== '' && (
                ...
                >
                  <div className="ck-editor__editable_inline">
                    <audio className="w-full" controls src={uploadedFileUrl}>
      ...
      {(isPreviewQuestion || isPreviewQuestionInside) && (
        <QuestionMultipleChoiceModalPreview
          ...
          title={!isPreviewQuestionInside ? 'Audio content' : undefined}
        />
      )}
      ...
      {(isPreviewFillTheGap || isPreviewFillTheGapInside) && (
        <FillTheGapModalPreview
          ...
          unitName={unitName}
          urlContent={urlContent}
          title={!isPreviewFillTheGapInside ? 'Audio content' : undefined}
        />
      )}
      ...
      {(isPreviewOrdering || isPreviewOrderingInside) && (
        <OrderingModalPreview
          ...
          unitName={unitName}
          urlContent={urlContent}
          title={!isPreviewOrderingInside ? 'Audio content' : undefined}
        />
      )}
      ...
      {(isPreviewDragAndDrop || isPreviewDragAndDropInside) && (
        <DragAndDropModalPreview
          ...
          unitName={unitName}
          urlContent={urlContent}
          title={!isPreviewDragAndDropInside ? 'Audio content' : undefined}
        />
      )}
      ...
      {(isPreviewFreeText || isPreviewFreeTextInside) && (
        <FreeTextModalPreview
          ...
          form={form}
          urlContent={urlContent}
          title={!isPreviewFreeTextInside ? 'Audio content' : undefined}
        />
      )}
...
export default CreateUnitWithAudio;
